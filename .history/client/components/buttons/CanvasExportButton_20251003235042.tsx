      ...
      <AlertDialog open={showSettings} onOpenChange={setShowSettings}>
        <AlertDialogContent>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="quality-slider" className="text-sm font-medium">الجودة (0.1 - 1.0)</label>
              <input
                id="quality-slider"
                type="range"
                min="0.1"
            ...
            <div>
              <label htmlFor="scale-slider" className="text-sm font-medium">مقياس التكبير</label>
              <input
                id="scale-slider"
                type="range"
                min="0.5"
            ...
            <div>
              <label htmlFor="background-color" className="text-sm font-medium">لون الخلفية</label>
              <input
                id="background-color"
                type="color"
